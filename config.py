...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002241612045"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Hydraspamj/Hina-assistant",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/botkild")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/botkilda")
...
STATS_IMG_URL = "https://telegra.ph/file/c71f53a6d7ac49f57e9b8.jpg"
...
if SUPPORT_CHANNEL:
    if not re.match("(?:http|https)://", SUPPORT_CHANNEL): "https://t.me/botkild"
        raise SystemExit(
            "[ERROR] - Your SUPPORT_CHANNEL url is wrong. Please ensure that it starts with https://"
        )

if SUPPORT_CHAT:
    if not re.match("(?:http|https)://", SUPPORT_CHAT): "https://t.me/botkilda"
        raise SystemExit(
